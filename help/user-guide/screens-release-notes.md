...
* **Criar/Publicar implantação (Fortalecimento)**

### Players do AEM Screens lançados

Os seguintes players do AEM Screens foram lançados para o Pacote de recursos 2 do AEM 6.4.2 e Pacote de recursos 4 do AEM 6.3.3:
