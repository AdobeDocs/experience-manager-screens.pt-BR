...
* O Inspect registra o console do reprodutor e verifica se há erros. Clique com o botão direito do mouse e inspecione para ver os logs do console. Se você estiver usando o Windows Player, pressione `CTRL + ALT +I` para ativar o console de desenvolvimento para exibir os logs.
...
Para obter mais informações sobre onde é possível monitorar a atividade do dispositivo, consulte [**Serviço de Notificações de Telas AEM**](screens-notifications-service.md).
