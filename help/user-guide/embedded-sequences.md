...
>[!NOTE]
>***Caminho do canal*** define uma referência explícita ao canal.Para saber mais sobre o *Caminho do canal*, consulte [Atribuição de canal](channel-assignment.md) em Criação de Screens.
