...
1. Clique em **Editar** na barra de ações e verifique se o URL do ponto de extremidade no campo Pontos de extremidade **do importador** também aponta para o URL do servidor de publicação no Distribution Agent.
