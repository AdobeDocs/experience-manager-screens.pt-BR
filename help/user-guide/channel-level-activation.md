...
>[!NOTE]
>
>Para saber mais sobre o AEM Screen Player, consulte os seguintes recursos:Downloads do AEM Screens PlayerTrabalhando com o AEM Screens Player](working-with-screens-player.md)
