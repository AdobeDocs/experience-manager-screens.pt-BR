...
user-guide-title: Práticas recomendadas para projetos do AEM Screens
...
# Práticas recomendadas para projetos do AEM Screens {#using}
...
+ Resumo do projeto {#design-brief}
...
+ Resumo da implantação {#deployment-brief}
   ...
   + [Assurance de teste e qualidade](testing-quality-assurance.md)
