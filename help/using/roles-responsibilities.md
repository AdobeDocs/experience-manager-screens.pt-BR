...
Os Criativos e a Gestão de conteúdo podem ser os seguintes:
...
* **Responsável**: Faz o trabalho de completar a tarefa.

* **Responsável**: Delega trabalho e é a última parte a revisar a tarefa antes de ela ser concluída.

* **Consultado**: Revisa a tarefa ou o material de entrega para fornecer informações.
...
| Avaliar Ambientes do Servidor Atual | I | RA | I | I |
